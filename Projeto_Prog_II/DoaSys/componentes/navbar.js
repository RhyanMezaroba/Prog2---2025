class CustomNavbar extends HTMLElement {
    connectedCallback() {
        ...
        // Nova forma segura de carregar Feather Icons no Shadow DOM
        requestAnimationFrame(() => feather.replace({ class: "icon", width: 18, height: 18, parent: this.shadowRoot }));
    }
    ...
    setupMobileMenu() {
        ...
        mobileBtn.addEventListener('click', () => {
            ...
            const newIcon = navLinks.classList.contains('open') ? 'x' : 'menu';
    ...
    updateActiveLink() {
        ...
        links.forEach(link => {
            ...
            if (
                href === currentPath ||
                (equivalents.includes(currentPath) && href === "/")
            ) {
