...
// Dados antigos e erros vindos do controller
$errors = $errors ?? [];
$old = $old ?? [];
?>
...
<body>
    ...
    <form method="post" action="/auth/register">
        ...
        <div class="actions">
            ...
            <a href="/auth/login" class="btn btn-secondary" style="text-decoration:none;margin-left:8px;display:inline-block;padding-top:8px;">Entrar</a>
        </div>
    </form>
