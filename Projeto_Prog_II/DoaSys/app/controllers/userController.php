...
class UserController extends baseController
{
    ...
    /** Tipos permitidos no ENUM */
    private $allowedTypes = ['cliente','instituicao','anonimo','admin'];
    ...
    public function store()
    {
        ...
        try {
            $insert = $this->db->prepare("
                ...
                VALUES (:nome, :email, :senha, :tipo, :documento, NOW())
            ");
    ...
    public function update($id)
    {
        ...
        try {
            $sql = "UPDATE usuarios 
                    SET nome = :nome, email = :email, tipo = :tipo, documento = :documento 
                    WHERE id = :id";
            ...
            if (!empty($data['password'])) {
                ...
                $this->db->prepare("UPDATE usuarios SET senha = :senha WHERE id = :id")
